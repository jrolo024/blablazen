        ...
        <div class="row">
            ...
            <div class="card text-white" style="background-color: #4A4444;">
                <div class="card-body">
                    ...
                    <span class="material-icons">phone</span> Numéro de téléphone : <span id="telephone"></span>
                </div>
            </div>
        </div>
    </div><br>
            ...
            <div class="col-8">
                <div class="card text-white" style="background-color: #7C4747;">
                    <div class="card-title">
                        <h1 style="text-align: center; margin-top:auto; margin-bottom:auto;">Les voyages que j'ai réservé</h1>
                    </div>
                </div>
            </div>
            </div>
            ...
            <div class="card bg-dark">
                <div class="card-body">
                    <div class="row mb-3" style="max-height: 10px;">
                        <div class="mx-auto">
                            <p class="text-warning" id="dep">Date de départ</p>
                        </div>
                        <div class="col-auto">
                            <p class="text-warning">Date d'arrivée</p>
                        </div>
                        <div class="col-auto">
                            <p class="text-warning" >Heure de départ</p>
                        </div>
                        <div class="col-auto">
                            <p class="text-warning">Heure d'arrivée</p>
                        </div>
                        <div class="col-auto">
                            <p class="text-warning">Nom du conducteur</p>
                        </div>
                        <div class="col-auto">
                            <p class="text-warning">Ville de départ</p>
                        </div>
                        <div class="col-auto">
                            <p class="text-warning">Ville d'arrivée</p>
                        </div>
                        <div class="col-auto">
        ...
        <div class="row">
            ...
            <div class="card bg-dark" style="background-color: #B09696;">
                <div class="card-body">
                    <div class="row mb-3" style="max-height: 10px;">
                        <div class="mx-auto">
                            <p class="text-warning">Date de départ</p>
                        </div>
                        <div class="col-auto">
                            <p class="text-warning">Date d'arrivée</p>
                        </div>
